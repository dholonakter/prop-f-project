...
namespace RentalApp
{
    public partial class RentalForm : Form
    {
        ...
        private void ResetGUI()
        {
            ...
            labelMessageB.Visible = false;
            buttonConfirm.Visible = false;
            buttonRemove.Visible = false;
            loanInfoLbx.Visible = false;
            returnDatePicker.Visible = false;

            label6.Visible = false;
            labelMessageR.Visible = false;
            returnLbx.Visible = false;
            ...
            if (v == null)
            {
                ...
                if (v != null)
                {
                    using (CrossThreadDisplay display = new CrossThreadDisplay(this))
                    {
                        ...
                        display.ToggleVisibility(label2);
                        display.ToggleVisibility(returnDatePicker);
                        display.ToggleVisibility(loanInfoLbx);
                        display.ToggleVisibility(label1);
                        display.ToggleVisibility(labelMessageB);
                        display.ToggleVisibility(buttonRemove);
                        display.ToggleVisibility(buttonConfirm);


                        display.ToggleVisibility(label6);
                        display.ToggleVisibility(labelInfoR);
                        display.ToggleVisibility(labelMessageR);
                        display.ToggleVisibility(returnLbx);
